...
CYTHON_CONSTRAINT="$ROOT_DIR/cython_constraint.txt"
pip install pip-tools==7.3.0
PIP_CONSTRAINT="$CYTHON_CONSTRAINT" pip install "ai-core-sdk[aicore-content]"
python -m pip install -r ${DATA_COLLECTION_DIR}/requirements-dev.txt
