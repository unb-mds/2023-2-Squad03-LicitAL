...
if __name__ == "__main__":
    ...
    for res in resultados:
        ...
        diario.atos = atos.extrair(res.texto)  # Chamada à função extrair com os valores das licitações
        del diario.texto
    ...
    with open(nome_arquivo, "w", encoding="utf8") as out_file:
        json.dump(res_atos, out_file, indent=2, default=str, ensure_ascii=False)
